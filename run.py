...
tvResults = Treeview(root, columns=('time', 'time_closure', 'size','size_closure', 'increased_time', 'reduced_size'))
...
tvResults.heading('increased_time', text='Increased time to')
